...
export default function Studio(){
 ...
 <header className="masthead"><a className="brand" href="./"><Mark/><span>STARLENS <small>ANATOMY STUDIO</small></span></a><div className="edition">AN INDEPENDENT EXPLORER <span>01</span></div><div className="header-actions"><button onClick={()=>help.current.showModal()}>How to use</button><a href="https://starlens-brain-atlas.sese16180.chatgpt.site/observatory" target="_blank" rel="noreferrer">Original atlas ↗</a><button onClick={reset}>Reset view</button></div></header>
